...
class _View_AppComponent_Host0 extends import1.AppView<any> {
  ...
  __TelnetService_0_5:import4.TelnetService;
  ...
  get _TelnetService_0_5():import4.TelnetService {
    if ((this.__TelnetService_0_5 == (null as any))) { (this.__TelnetService_0_5 = new import4.TelnetService(this.parentInjector.get(import9.Http))); }
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import4.TelnetService) && (0 === requestNodeIndex))) { return this._TelnetService_0_5; }
